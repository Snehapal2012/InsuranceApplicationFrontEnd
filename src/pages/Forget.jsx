...
import insu1 from './assests/insu1.png';
...
class ForgetPassword extends Component {
    ...
    render() {
        ...
        return (
            <div align="center" className="mainContent">
                <Header />
                <div align="right" className='content'>
                    <div className="topContent"></div>
                    <div className="subContent">
                        <div className="leftContent"></div>
                        <div className='split-left'>
                            <div>
                                <img src={insu1} alt="assets" />
                            </div>
                        </div>
                            ...
                            <div className="outerBorder">
                                <div className="form">
                                    ...
                                    <div className="PasswordContent">
                                        ...
                                        {/* <div className='onclick' onClick={this.handleClickShowPassword}><i id='eye_icon' className="fa fa-eye" ></i></div> */}
                                    ...
                                    <div className="bottomContent" style={{"textAlign":'center'}}>
